    ...
    public class LinqSamples
    {
        ...
        */
        ...
        public void Przyklad1()
        {
            ...
            var resLambda = Emps.Where(emp => emp.Job == "Backend programmer");
            PrintResult(resLambda);
        }
        ...
        {
            var res = Emps.Join(Depts, emp => emp.Deptno, dept => dept.Deptno, (emps, depts) => new { 
        ...
        public void Przyklad10Button_Click()
        {
            ...
            Func<Emp, object> basicSelect = emp => new {
                emp.Ename,
                emp.Job,
                emp.HireDate
            };
            ...
            var res = Emps
                .Select(basicSelect)
                .Union((new[] { emptyEmp }).Select(basicSelect));
        ...
        {
            var res = Emps.Aggregate((Emp acc, Emp currentEmp) => 
                acc.Salary > currentEmp.Salary ? acc : currentEmp);
        ...
        private void PrintResult(IEnumerable res)
        {
